...
export const CardProduct: React.FC<{ product: InProduct; handleAddToCart: (id: string) => void; }> = ({ product, handleAddToCart }) => {
    ...
    return (
        <Card className="fadeIn" sx={{ display: "flex", boxShadow: 3, width: "100%", maxWidth: { xs: "100%", md: "48%", lg: "32%" }, maxHeight: "155px", transition: "0.2s", "&:hover": { boxShadow: 12 } }}>
            <Box sx={{ width: "100%" }}>
            ...
            <CardMedia
                ...
                sx={{ width: { xs: 130, md: 140, lg: 145 }, objectFit: "fill" }}
                alt={"Imagen Producto"}
            />
        </Card>
    );
